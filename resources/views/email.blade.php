        ...
        <ul class="nav navbar-nav side-nav nicescroll-bar">
            ...
            <li>
                ...
                <ul id="app_dr" class="collapse collapse-level-1">
                    ...
                    <li>
                        <a class="active-page" href="javascript:void(0);" data-toggle="collapse" data-target="#email_dr">Email<div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
                        <ul id="email_dr" class="collapse collapse-level-2">
                            <li>
                                <a class="active-page" href="inbox.html">inbox</a>
                            </li>
                            <li>
